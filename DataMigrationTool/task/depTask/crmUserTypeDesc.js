...
module.exports = function () {
    ...
    function task(resolve, reject) {
        ...
        var option = url.parse(config.crmApi.crmUserTypeDesc.url + "?" + querystring.stringify(query));
        option.method = config.crmApi.crmUserTypeDesc.method;
        option.headers = {
